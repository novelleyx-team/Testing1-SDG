            ...
            {status === "sent" ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input required type="text" className="w-full rounded-lg border border-gray-300 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#2563EB] focus:border-transparent" placeholder="Your Full Name" />
                </div>
                <div>
