  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-20 animate-in fade-in duration-0">
      <div>
        ...
        <p className="text-gray-500 mt-1">Manage your platform preferences and notification rules.</p>
      </div>
      ...
      <div className="space-y-6">
          ...
          <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-0.5">Receive AI analysis results and faculty feedback via email.</p>
              </div>
              <button 
                onClick={() => setEmailNotifs(!emailNotifs)}
                className={`w-12 h-6 rounded-full transition-colors relative ${emailNotifs ? 'bg-blue-600' : 'bg-gray-200'}`}
              >
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-0.5">Get browser alerts for approaching project deadlines.</p>
              </div>
              <button 
                onClick={() => setPushNotifs(!pushNotifs)}
                className={`w-12 h-6 rounded-full transition-colors relative ${pushNotifs ? 'bg-blue-600' : 'bg-gray-200'}`}
              >
        ...
        <Card className="rounded-[18px] shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-gray-100 bg-white overflow-hidden">
          <div className="p-6 border-b border-gray-100 flex items-center gap-3 bg-gray-50/50">
            ...
            <h3 className="font-bold text-gray-900 text-lg">Appearance</h3>
          </div>
          <div className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <h4 className="font-bold text-gray-900 dark:text-gray-100">Dark Mode</h4>
                <p className="text-sm text-gray-500 mt-0.5">Toggle the platform&apos;s visual theme.</p>
              </div>
              {mounted && (
                <button 
          ...
          <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
              <div className="flex items-start gap-4">
                <Smartphone className="text-gray-400 mt-1" size={24} />
                <div>
                  <h4 className="font-bold text-gray-900">Two-Factor Authentication</h4>
                  <p className="text-sm text-gray-500 mt-0.5">Add an extra layer of security to your academic account.</p>
                </div>
              </div>
              <button className="text-sm font-bold text-blue-600 hover:text-blue-700 hover:bg-blue-50 px-4 py-2 rounded-xl transition-colors border border-blue-100">
                Setup 2FA
              </button>
            </div>
          </div>
