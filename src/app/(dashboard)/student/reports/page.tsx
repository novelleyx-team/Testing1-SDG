...
const reports: { id: string, title: string, type: string, date: string, status: string, size: string }[] = [];
    ...
    <div className="max-w-7xl mx-auto space-y-8 pb-20 animate-in fade-in duration-0">
      ...
      {reports.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">No Reports Available</h3>
          <p className="text-gray-500 dark:text-gray-400">Complete a project evaluation to generate your first AI impact report.</p>
        </div>
      )}
    </div>
  );
