    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-20 animate-in fade-in duration-0">
      <div>
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-1">
          Manage your executive preferences, reports, and security.
        </p>
      </div>
        ...
        <Card className="rounded-[18px] shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-gray-100 dark:border-gray-800 bg-white dark:bg-[#1F2937] overflow-hidden">
          ...
          <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <h4 className="font-bold text-gray-900 dark:text-gray-100">Weekly Digest</h4>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Receive a weekly email digest of institutional SDG progress.</p>
              </div>
              <button 
            ...
            <div className="flex items-center justify-between">
              <div>
                <h4 className="font-bold text-gray-900 dark:text-gray-100">Critical Alerts</h4>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Get immediate push notifications for critical policy changes.</p>
              </div>
              <button 
