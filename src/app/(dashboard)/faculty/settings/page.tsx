    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-20 animate-in fade-in duration-0">
      <div>
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-1">
          Manage your platform preferences, review alerts, and security settings.
        </p>
      </div>
          ...
          <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Receive alerts for new student project submissions and reviews.</p>
              </div>
              <button 
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Get browser alerts for urgent departmental announcements.</p>
              </div>
              <button 
